...
/* Define if libfuse is available */
#define HAVE_FUSE 1

/* Define if libfuse is available */
#define HAVE_FUSE_CACHE_READDIR 0
...
/* Define to 1 if you have the `open_by_handle_at' function. */
...
#define PACKAGE_STRING "fuse-overlayfs 0.6.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fuse-overlayfs"
